...
// upstream counterpart at all: core-201, the 26 OCPP 2.0.1 scenarios written
// here rather than ported. 73 in total.
//
...
async function checkDriver(argv: string[]): Promise<number> {
  ...
  if (capabilities) {
    ...
    // driver warnings for operations it never claimed, which is exactly
