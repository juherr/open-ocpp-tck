 ...
 */
export declare function profileEvseIds(connectors: number): number[];
/**
 ...
 */
export declare const FIXTURE_EVSE_PREFIX = "TCK*FIXTURE*";
/** The `evseId` of one provisioned EVSE row. */
export declare function fixtureEvseId(cpId: string, evseId: number): string;
/**
