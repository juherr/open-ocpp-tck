 ...
 */
export declare function assertCallCount(rec: AssertRecorder, frames: readonly Frame[], direction: Direction, action: string, expected: number, description: string): void;
/**
